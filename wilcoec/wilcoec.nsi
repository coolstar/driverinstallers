...
Section "Default Keyboard Presets (Dell 7410)"
  ${DisableX64FSRedirection}
  CopyFiles "$INSTDIR\drivers\croskbsettings-wilco.bin" "C:\Windows\system32\drivers\croskbsettings.bin"
